...
- [Team Timezone Wall](https://github.com/jharohit/team-timezone-wall) - A simple, elegant, and customizable web-based clock wall designed to help distributed teams keep track of different timezones at a glance. `MIT` `HTML`
